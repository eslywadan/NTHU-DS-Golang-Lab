...
var _ = Describe("WorkerPool", func() {
		...
		Describe("Start", func(){
				...
				When("done all tasks nornmally", func(){
						BeforeEach(func() {
				...
				Context("with channel", func() {
						...
						When("cancel before all jobs done", func() {
								...
								It("finish half of jobs and closes the result channel", func() {
						...
						When("cancel after all jobs done", func() {
								...
								It("finiishes all jobs and closes the result channel", func() {
										for i := 0; i < numWorkers*2; i++ {
												Expect(wp.Results()).To(Receive(Equal(&Result{
														Value: 1,
														Err: 	nil,
